...
public enum AccountTypes {
    ...
    public static AccountTypes obtenerCuenta(Boolean renaperValid, Double verazScore, Boolean worldSysFlag, Double sueldoBruto) {
        ...
        for (AccountTypes tipo : AccountTypes.values()) {
            if (tipo != NO_ELIGIBLE && verazScore <= tipo.getVerazScore() &&
